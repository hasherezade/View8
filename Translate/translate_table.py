...
operands = {
    ...
    "LdaConstant": lambda obj: f"ACCU = ConstPoolLiteral{obj.args[0]}",
    "LdaNamedProperty": lambda obj: f"ACCU = {obj.args[0]}[ConstPoolLiteral{obj.args[1]}]",
    "LdaNamedPropertyFromSuper": lambda obj: f"ACCU = ACCU[ConstPoolLiteral{obj.args[1]}]",
    ...
    "StaNamedOwnProperty": lambda obj: f"{obj.args[0]}[ConstPoolLiteral{obj.args[1]}] = ACCU",
    "StaNamedProperty": lambda obj: f"{obj.args[0]}[ConstPoolLiteral{obj.args[1]}] = ACCU",
    ...
    "SetNamedProperty": lambda obj: f"{obj.args[0]}[ConstPoolLiteral{obj.args[1]}] = ACCU",
    "SetKeyedProperty": lambda obj: f"{obj.args[0]}[{obj.args[1]}] = ACCU",
    "DefineNamedOwnProperty": lambda obj: f"{obj.args[0]}[ConstPoolLiteral{obj.args[1]}] = ACCU",
